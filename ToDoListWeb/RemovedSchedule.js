...
window.addEventListener('message', function(event) {
     ...
     if(receiveData === 'onload'){
        changeCheckbox();
        console.log(localStorage.getItem(infoList));
        console.log(infoList);
        return;
    }

    if(typeof receiveData === 'object' && receiveData != null){
    infoList.push(receiveData);
    console.log(infoList);

    localStorage.setItem('removedList', JSON.stringify(infoList));
    console.log(localStorage.getItem('removedList'));
...
function changeCheckbox(){
    var value = localStorage.getItem('removedList');
